...
class EmployeeEobi(models.AbstractModel):
    _name = 'report.de_employee_eobi_report.report_eobi'
    ...
    def _get_report_values(self,docids, data=None):
        ...
        if docs.department_id and docs.location_id:
            employees = self.env['hr.employee'].search([('department_id','=',docs.department_id.id),('work_location_id','=',docs.location_id.id)])
